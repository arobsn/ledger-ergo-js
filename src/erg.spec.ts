...
const txTestVectors = [
  {
    ...
    proofs: [
      Uint8Array.from([
        68, 90, 41, 103, 107, 77, 70, 59, 154, 66, 102, 174, 66, 213, 208, 70,
        230, 97, 14, 147, 99, 71, 214, 174, 10, 34, 200, 245, 57, 246, 237, 96,
        119, 119, 126, 148, 120, 245, 1, 230, 87, 234, 188, 107, 140, 239, 212,
        6, 192, 10, 80, 184, 8, 64, 165, 254
      ])
    ]
  },
  {
  ...
  },
  {
    ...
    tx: {
      inputs: [
        {
          ...
          value: "7553272000",
          ergoTree: Buffer.from([
            16, 6, 4, 0, 14, 32, 215, 22, 147, 196, 154, 132, 251, 190, 205, 73,
            8, 201, 72, 19, 180, 101, 20, 177, 139, 103, 169, 153, 82, 220, 30,
            110, 71, 145, 85, 109, 228, 19, 4, 0, 4, 0, 5, 0, 5, 0, 216, 3, 214,
            1, 227, 0, 4, 214, 2, 228, 198, 167, 4, 8, 214, 3, 228, 198, 167, 5,
            5, 149, 230, 114, 1, 216, 4, 214, 4, 178, 165, 228, 114, 1, 0, 214,
            5, 178, 219, 99, 8, 114, 4, 115, 0, 0, 214, 6, 219, 99, 8, 167, 214,
            7, 153, 193, 167, 193, 114, 4, 209, 150, 131, 2, 1, 150, 131, 5, 1,
            147, 194, 114, 4, 194, 167, 147, 140, 114, 5, 1, 115, 1, 147, 228,
            198, 114, 4, 4, 8, 114, 2, 147, 228, 198, 114, 4, 5, 5, 114, 3, 147,
            228, 198, 114, 4, 6, 14, 197, 167, 150, 131, 2, 1, 146, 156, 153,
            140, 114, 5, 2, 149, 145, 177, 114, 6, 115, 2, 140, 178, 114, 6,
            115, 3, 0, 2, 115, 4, 114, 3, 114, 7, 146, 114, 7, 115, 5, 114, 2
          ]),
          ...
          additionalRegisters: Buffer.from([
            3, 8, 205, 2, 15, 69, 105, 90, 11, 147, 166, 49, 136, 74, 44, 208,
            113, 106, 114, 82, 35, 35, 103, 133, 40, 82, 43, 49, 92, 84, 214,
            207, 156, 96, 76, 215, 5, 224, 209, 4, 14, 32, 219, 170, 253, 50,
            105, 221, 13, 51, 44, 153, 13, 165, 25, 164, 138, 117, 2, 78, 12,
            139, 200, 129, 160, 25, 177, 193, 63, 250, 87, 8, 230, 31
          ]),
      ...
      outputs: [
        ...
        },
        {
          ...
          registers: Buffer.from([
            3, 8, 205, 2, 15, 69, 105, 90, 11, 147, 166, 49, 136, 74, 44, 208,
            113, 106, 114, 82, 35, 35, 103, 133, 40, 82, 43, 49, 92, 84, 214,
            207, 156, 96, 76, 215, 5, 224, 209, 4, 14, 32, 136, 100, 48, 96, 84,
            152, 13, 65, 112, 159, 76, 237, 216, 134, 240, 108, 158, 221, 45,
            15, 89, 161, 74, 250, 145, 226, 101, 96, 119, 216, 3, 242
          ])
        },
        {
          value: "2204000",
      ...
      distinctTokenIds: [
        Uint8Array.from([
          239, 128, 43, 71, 92, 6, 24, 159, 219, 248, 68, 21, 60, 220, 29, 68,
          154, 91, 168, 124, 206, 19, 209, 27, 180, 123, 90, 83, 159, 39, 241,
          43
        ]),
        Uint8Array.from([
          215, 22, 147, 196, 154, 132, 251, 190, 205, 73, 8, 201, 72, 19, 180,
          101, 20, 177, 139, 103, 169, 153, 82, 220, 30, 110, 71, 145, 85, 109,
          228, 19
        ])
      ],
      changeMap: {
    ...
    proofs: [
      Uint8Array.from([
        228, 0, 151, 4, 137, 84, 132, 119, 5, 78, 45, 157, 172, 174, 204, 178,
        193, 69, 249, 227, 25, 235, 202, 62, 90, 187, 180, 190, 115, 250, 4, 2,
        197, 134, 141, 125, 250, 104, 173, 255, 233, 180, 192, 134, 61, 74, 206,
        60, 60, 161, 247, 144, 129, 90, 237, 51
      ]),
      Uint8Array.from([
        228, 0, 151, 4, 137, 84, 132, 119, 5, 78, 45, 157, 172, 174, 204, 178,
        193, 69, 249, 227, 25, 235, 202, 62, 90, 187, 180, 190, 115, 250, 4, 2,
