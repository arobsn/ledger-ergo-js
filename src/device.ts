...
export enum RETURN_CODE {
  ...
  NO_APP_NAME_PROVIDED = 0x670a,
  UNKNOWN_APPLICATION_NAME = 0x6807
}
...
export const RETURN_MESSAGES = {
  ...
  [RETURN_CODE.NO_APP_NAME_PROVIDED]: "No app name provided",
  [RETURN_CODE.UNKNOWN_APPLICATION_NAME]: "Unknown application name"
};
